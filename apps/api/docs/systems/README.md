...
| System Administration (Control Plane) | `src/modules/saas` | `Account, Company, CompanyUser, Module, Menu, CompanyModule, Role, RoleMenu, Invitation, RegistrationLead` + subscriber-owned reference data (`IndustryType, Salutation, Nationality, PublicHoliday`) | [system-administration.md](system-administration.md) |
