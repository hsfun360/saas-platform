// Bundled ISO alpha-2 -> E.164 calling code map. world_countries (our name/i18n
// source) has NO calling codes, and deriving them from other datasets' idd
// root/suffix shape is unreliable for NANP (+1) countries. This curated map keeps
// it accurate and dependency-free; countries not listed keep a null dialCode and
// can be filled in on the Countries maintenance screen. Extend as needed.
const DIAL_CODES = {
    ...
    co: '+57', km: '+269', cg: '+242', cd: '+243', cr: '+506', ci: '+225', hr: '+385',
    ...
    gh: '+233', gr: '+30', gd: '+1', gt: '+502', gn: '+224', gw: '+245', gy: '+592',
